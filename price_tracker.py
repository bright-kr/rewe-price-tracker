...
Info  : https://brightdata.co.kr/products/insights/price-tracker/rewe
"""
...
# https://brightdata.co.kr/products/web-scraper/rewe
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your REWE scraper at: https://brightdata.co.kr/products/web-scraper/rewe\n"
